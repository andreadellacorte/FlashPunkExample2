package splash 
{
	...
	public class Splash extends Entity
	{
		 ...
		 */
		public function Splash(color:uint = 0xff3366, bgColor:uint = 0x202020, fadeTime:Number = 1, logoTime:Number = 4.5, poweredByTime:Number = 0, scale:Number = 1, xPercent:Number = .5, yPercent:Number = .6) 
		{
			_scale = scale;
